...
namespace App\Tests\Infrastructure\Ar24\Http\RegisteredMail\DataTransformer;
...
final class RegisteredMailDataTransformerTest extends TestCase
{
    ...
    {
        $this->transformer = new RegisteredMailDataTransformer(new AutomaticTransformer());
    }
