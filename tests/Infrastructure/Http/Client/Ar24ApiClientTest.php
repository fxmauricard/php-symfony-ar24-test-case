...
namespace App\Tests\Infrastructure\Http\Client;
...
#[CoversNothing]
class Ar24ApiClientTest extends TestCase
{
    public function test_success_plain_json_and_masks_token_in_logs(): void
    {
        ...
        $headersFactory = new Ar24HeadersFactory('private-key');
        $decrypter = new Ar24ResponseDecrypter('private-key');
        ...
        $client = new Ar24ApiClient($httpClient, $headersFactory, $decrypter, $logger, $baseUrl, $token);
    ...
    public function test_decrypts_encrypted_payload(): void
    {
        ...
        $headersFactory = new Ar24HeadersFactory($privateKey);
        $decrypter = new Ar24ResponseDecrypter($privateKey);
    ...
    public function test_throws_on_non_200_status(): void
    {
        ...
        $this->expectException(Ar24ApiException::class);
        $client->get('/foo');
    }
    ...
    public function test_handle_error_token_missing_maps_to_token_exception(): void
    {
        ...
        $this->expectException(Ar24TokenException::class);
        $client->get('/foo');
    }
    ...
    public function test_handle_error_invalid_date_maps_to_date_exception(): void
    {
        ...
        $this->expectException(Ar24DateException::class);
        $client->get('/foo');
    }

    #[AllowMockObjectsWithoutExpectations]
    private function createClientWithErrorSlug(string $slug): Ar24ApiClient
    {
        $baseUrl = 'https://api.example.com';
        $token = 'tkn';
        ...
        return new Ar24ApiClient($httpClient, $headersFactory, $decrypter, $logger, $baseUrl, $token);
    }
}
